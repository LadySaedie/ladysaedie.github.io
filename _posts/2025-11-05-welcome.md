---
title: "WELCOME TO MY 'LADY SAEDIE' BLOG"
...
key words (I renamed mine to 'tags'):  
...
E.g., \> Add Markdown syntax content to file `_tabs/about.md`{: .filepath } and it will show up on this page. The .filepath code is styling only.
{: .prompt-info }
